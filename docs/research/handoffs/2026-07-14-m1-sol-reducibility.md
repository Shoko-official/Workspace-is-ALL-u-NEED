...
3. A resource vector and pathwise mask are generic CMDP/BMDP machinery, while cost-sensitive store routing is explicit in Gaikwad.
...
| Cost-sensitive routing across memory stores | [Gaikwad, *Did You Check the Right Pocket?*, arXiv:2603.15658v1](https://arxiv.org/pdf/2603.15658), Sections 3.1-3.4, PDF pages 2-3 | A policy selects among four stores and optimizes expected accuracy minus access cost |
