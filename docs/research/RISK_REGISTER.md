...
| R-015 | The direction-setting pivot becomes a survey, manifesto, maturity model, or renamed roadmap | High | High | Require an implementation-neutral technical contract, falsifiable regime predictions, and a separate prior-art audit before drafting | Contribution can be reproduced by arranging known memory, state, and compute systems into stages | Sol-PI / Terra-Evidence | OPEN |
